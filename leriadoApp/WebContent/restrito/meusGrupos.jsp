	...
	<div class="row grey lighten-3 conteudo">
				...
				<div class="col s12 l12">
					<ul class="collection">
						...
						<li class="collection-item avatar"><img
							src="../userimg/${fotoPerfil.arquivo}" class="circle"> <b>${usuarioLogado.nome}
								${usuarioLogado.sobrenome}</b> <c:if test="${msg!=null}">
								<p class="red-text">${msg}</p>
							</c:if></li>
						<b class="grey-text text-darken-3">Feed</b>
						<div class="divider"></div>
						<a href="/leriadoApp/restrito/home.jsp" class="collection-item">Feed
							de Notícias</a>
						...
						<div class="divider"></div>
						<a href="/leriadoApp/restrito/meusGrupos.jsp"
							class="collection-item">Meus Grupos</a>
					</ul>
				</div>
			</div>
		</div>
		<div class="col s12 l8 white lighten-2">
			...
			<div class="col s12 l6 push-l3"">
				<form
					action="/leriadoApp/Leriado?command=GrupoController&acao=criarGrupo"
					method="post" enctype="multipart/form-data">
					<div class="input-field">
						<input type="text" name="nome" id="nome" required /> <label
							for="nome">Nome do Grupo</label>
					</div>
					<div class="input-field">
						<input type="text" name="descricao" id="descricao" required /> <label
							for="descricao">Descrição do Grupo</label>
					</div>
