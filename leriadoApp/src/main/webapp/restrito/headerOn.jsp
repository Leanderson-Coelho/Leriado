		...
		<nav>
			<div class="container">
				<div class="nav-wrapper">
					<a href="/leriadoApp/restrito/home.jsp" class="brand-logo "><img class="logo" src="../img/logobranco.png" /></a>
					<a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
					<ul class="right hide-on-med-and-down">
						<li><a href="meusGrupos.jsp"><i class="material-icons right">group</i>Meus Grupos</a></li>
...
<ul class="sidenav" id="mobile-demo">
    ...
    <li><a href="meusGrupos.jsp"><i class="material-icons">group</i>Meus Grupos</a></li>
	<li><a href="/leriadoApp/restrito/atualizar.jsp"><i
			class="material-icons">edit</i>Atualizar Conta</a></li>
	<li><a
