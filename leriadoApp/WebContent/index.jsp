			...
			<div class="row">
				...
				<div class="col s6">
					<section>
						...
						<form method="POST"
							action="Leriado?command=UsuarioController&acao=cadastrar"
							class="col s12">
							<div class="row">
							...
							<div class="row">
								<div class="col s6 input-field">
									<input type="text" name="rua" id="rua" /> <label for="rua">Rua</label>
								</div>
								<div class="col s6 input-field">
							...
							<div class="input-field">
								<button class="btn waves-effect waves-light" type="submit"
									name="action">
									Que o Leriado comece!! <i class="material-icons right">send</i>
								</button>
							</div>
						</form>
					</section>
