				...
				<div class="col s12">
					<ul class="collection">
						...
						<li class="collection-item avatar"><img
							src="../userimg/b136693d02a2ce0468ab51be43f0e04f" class="circle">
							<p>${usuarioLogado.nome}${usuarioLogado.sobrenome}</p></li>
						<!-- GRUPOS -->
						<a class="collection-item modal-trigger" href="#modal1">Aprendendo
							Redis</a>
					</ul>
					<!-- GERENCIA GRUPO -->
						...
						<div class="modal-content ">
							...
							<div class="row">
								<div class="col s12">
									...
									<form
										action="/leriadoApp/Leriado?command=GrupoController&acao=adicionarUsuario"
										method="post">
										<input hidden type="text" value="Aprendendo Redis"
											name="nomeGrupo" />
